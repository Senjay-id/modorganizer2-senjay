                                              ...
                                              std::optional<uint64_t> fileSize)
{
  ...
  info->m_FileInfo->domainName   = metaFile.value("domainName").toString();
...
void DownloadManager::createMetaFile(DownloadInfo* info)
{
  ...
  metaFile.setValue("domainName", info->m_FileInfo->domainName);
                                              ...
                                              QVariant resultData, int requestID)
{
  ...
  info->m_FileInfo->domainName  = result["domain_name"].toString();
  QTextDocument doc;
                                        ...
                                        QVariant resultData, int requestID)
{
  ...
  for (QVariant file : files) {
    ...
    if ((fileName == info->m_RemoteFileName) ||
      ...
      info->m_FileInfo->domainName  = fileInfo["domain_name"].toString();
      found                         = true;
      break;
    }
  }
                                                  ...
                                                  QVariant resultData, int requestID)
{
  ...
  info->m_FileInfo->domainName  = modDetails["domain_name"].toString();
